...
- **Ctrl + F12**: To select all occurrences of current word
...
### **Terminal commands**
- **Ctrl + J**: To toggle panel area, in order to have more space for the actual file
- **Ctrl + 1**: Switch back to code
